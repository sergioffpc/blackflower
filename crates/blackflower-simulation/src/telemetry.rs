...
impl TickObservation {
    ...
    pub(crate) fn finish(self, _result: &Result<bool, RunError>) {
        ...
        #[cfg(feature = "metrics")]
        {
            ...
            .increment(1);
            metrics::histogram!("blackflower_simulation_tick_duration_seconds")
                .record(elapsed.as_secs_f64());
            if elapsed > self.deadline {
                metrics::counter!("blackflower_simulation_deadline_misses_total").increment(1);
            }
        }
...
pub(crate) fn describe_metrics() {
    #[cfg(feature = "metrics")]
    {
        ...
        metrics::describe_counter!(
            "blackflower_simulation_deadline_misses_total",
            Unit::Count,
