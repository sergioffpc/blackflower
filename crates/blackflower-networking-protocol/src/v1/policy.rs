...
pub const POSITION_TOLERANCE_METERS: f64 = 0.02;
/// Maximum accepted client/server linear-velocity error, in metres per second.
pub const VELOCITY_TOLERANCE_METERS_PER_SECOND: f64 = 0.05;
/// Maximum accepted shortest-arc orientation error: half a degree in radians.
pub const ORIENTATION_TOLERANCE_RADIANS: f64 = std::f64::consts::PI / 360.0;
