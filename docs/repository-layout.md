...
| Offline Linux cooker, Python | `tools/cooker/` | Installed CLI `blackflower-cooker`, also runnable as an installed module `python -m content`. A Python package distribution is sufficient; no frozen executable is required by this proposal. |
