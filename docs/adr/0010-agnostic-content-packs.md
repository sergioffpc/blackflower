...
step. Bounds are stored in world space inside their owning entity; adapters must
not apply entity placement again. Consumers no longer receive global spawn or
light collections.
