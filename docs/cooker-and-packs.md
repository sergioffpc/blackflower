...
| --------- | --------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------- |
| Scenario  | Geometric primitives, lights, spawn points, stable resource identities, and validated references                                              | Load project-owned scene values and ECS entities.                                      |
