...
1.  **The user demonstrated genuine understanding of something non-trivial**:
    not just exposure, but evidence they can use the concept correctly. This
    sets a new floor for what to teach next.
...
-   Material that was merely covered. Coverage is not learning. Wait for
    evidence.
