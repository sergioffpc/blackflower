...
agent will work from. The original body and discussion are context: the agent
...
left to do _to the existing diff_: finish it, close gaps, address review points.
...
change in the meantime. Write the brief so it stays useful even as files are
