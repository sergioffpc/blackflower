...
linker choices otherwise do not reach Autotools. Linux retains the upstream
build recipe. The project Windows toolchain places Clang intrinsic headers
before Microsoft declarations and selects llvm-ar for GNU archive rules.
